...
SDK
EVM contracts can program against the Stork contract's interface by using the stork-evm-sdk npm package available on npmjs.com. This SDK provides an interface and useful struct for interacting with the Stork Contract.

The Stork contract can also be used via the Pyth and Chainlink adapters.

The Stork contract is built using Hardhat.
