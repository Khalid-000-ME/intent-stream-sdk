...
async function main() {
    ...
    // Setup Viem Clients
    // Setup Viem Clients
    const DEV_KEY = '0xe844e40e45c5d163f0142b255799d239802bdcf867f45385c7e54735fe721d59';
    let PRIVATE_KEY = process.env.PRIVATE_KEY as `0x${string}`;

    // Validate key format (simple check)
    if (!PRIVATE_KEY || !PRIVATE_KEY.startsWith('0x') || PRIVATE_KEY.length !== 66) {
        console.log('⚠️ PRIVATE_KEY not found or invalid in .env. Using known Dev Key.');
        PRIVATE_KEY = DEV_KEY;
    }
