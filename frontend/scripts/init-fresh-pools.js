...
/**
 * FINAL CORRECT MATH:
 * Target: 1 ETH = 2500 USDC
 * Token0: USDC (10^6), Token1: WETH (10^18)
 * 1 unit USDC = 1/2500 * 10^-6 ETH = 0.0000004 ETH = 400,000,000 units WETH
 * P = 400,000,000
 * sqrtP = 20,000
...
const sqrtP = 20000n;
const Q96 = 2n ** 96n;
const SQRT_PRICE_X96 = (sqrtP * Q96).toString();

async function main() {
    console.log("\n💎 \x1b[36mUNIFLOW GOLD-STANDARD POOL DEPLOYMENT\x1b[0m 💎");
    console.log(`Target: 1 ETH = 2500 USDC | Fee: ${FEE} | TS: ${TICK_SPACING}\n`);
    console.log(`Computed sqrtPriceX96: ${SQRT_PRICE_X96}`);

    for (const [net, chain] of Object.entries(CONFIG)) {
        console.log(`\n🚀 Initializing on ${net.toUpperCase()}...`);
        ...
        try {
            ...
            console.log(`   ℹ️  Skipped: ${e.message.split('(')[0]}`);
        }
    }
    console.log("\n✨ System is now perfectly balanced on Fee 200.");
}
