# Uniswap v4 - Set Up Local Environment for Hooks
...
If there is no Foundry installed - follow the [Foundry Book](https://book.getfoundry.sh/) for installation.
...
**Source:** [Uniswap v4 Documentation - Set Up Local Environment](https://docs.uniswap.org/contracts/v4/quickstart/hooks/setup)
