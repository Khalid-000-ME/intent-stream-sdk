...
contract AddSignificantLiquidity is Script {
    using CurrencyLibrary for Currency;
    
    // Official Base Sepolia deployments
    ...
    function run() external {
        ...
        console.log("=== Adding Significant Liquidity (50 USDC) ===");
        ...
        // Target: ~50 USDC
        // Empirically: 1e6 liquidity delta ~= 1 USDC
        // So 50e6 liquidity delta ~= 50 USDC
        int256 liquidityDelta = 50_000_000;
        
        console.log("\nAdding liquidity:");
        console.log("  Target: ~50 USDC + equivalent WETH");
